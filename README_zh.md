...
* 开发者 [Mahdi-zarei](https://github.com/Mahdi-zarei/) 在 2024.4.30 开始，因为原开发者的长时间不活动而建立了自己的[分支版](https://github.com/Mahdi-zarei/nekoray/)，从4.0.0开始至4.3.7，对nekoray进行 hotfix 后，2025.7.18 把项目改名为 [FreeLink](https://github.com/freelinkproj/freelink/)。
...
[![GitHub All Releases](https://img.shields.io/github/downloads/freelinkproj/FreeLink/total?label=downloads-total&logo=github&style=flat-square)](https://github.com/freelinkproj/FreeLink/releases)
